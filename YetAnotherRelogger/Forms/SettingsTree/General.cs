...
namespace YetAnotherRelogger.Forms.SettingsTree
{
    public partial class General : UserControl
    {
        ...
        {
            Settings.Default.AlwaysShowTray = checkBox1.Checked;
            Program.Mainform.ToggleIcon();
        }

        private void checkBox2_CheckedChanged(object sender, EventArgs e)
        {
            Settings.Default.MinimizeToTray = checkBox2.Checked;
        }

        private void checkBox4_CheckedChanged(object sender, EventArgs e)
        {
            Settings.Default.CloseToTray = checkBox4.Checked;
        }

        private void checkBox3_CheckedChanged(object sender, EventArgs e)
        {
            Settings.Default.ShowNotification = checkBox3.Checked;
        }

        private void checkBox5_CheckedChanged(object sender, EventArgs e)
        {
            Settings.Default.UseD3Starter = checkBox5.Checked;
        }

        private void textBox1_TextChanged(object sender, EventArgs e)
        {
            Settings.Default.D3StarterPath = textBox1.Text;
        }
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            if (ofd.ShowDialog() == DialogResult.OK)
            {
                ...
                Settings.Default.D3StarterPath = ofd.FileName;
            }
            ofd.Dispose();
        }
        ...
        {
            Settings.Default.ISBoxerPath = textBox2.Text;
        }
