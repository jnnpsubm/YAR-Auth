        ...
        internal class ScreensClass
        {
            ...
            public Rectangle Bounds
            {
                ...
                get
                {
                    ...
                    if (Settings.Default.AutoPosForceWorkingArea)
                        return new Rectangle((int) Settings.Default.AutoPosForceWorkingAreaX,
                            (int) Settings.Default.AutoPosForceWorkingAreaY,
                            (int) Settings.Default.AutoPosForceWorkingAreaW,
                    ...
                    try
                    {
                        ...
                        {
                            Logger.Instance.WriteGlobal(
                                "ERROR: screen \"{0}\" does not exist! using primary screen sizes");
