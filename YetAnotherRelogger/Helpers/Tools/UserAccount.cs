...
namespace YetAnotherRelogger.Helpers.Tools
{
    public static class UserAccount
    {
        ...
        public static bool Exists(string username)
        {
            ...
            return (from DirectoryEntry child in directoryEntry.Children
                where child.SchemaClassName == "User"
                let props = child.Properties
                select child).Any(child => child.Name.ToLower().Equals(username.ToLower()));
        }
